...
#[derive(serde::Serialize, serde::Deserialize, Clone, Debug)]
pub struct LightEpochSyncConfig {
...
impl Default for LightEpochSyncConfig {
    fn default() -> Self {
        Self {
            epoch_sync_horizon: 216000,
            epoch_sync_accept_proof_max_horizon: 86400,
            timeout_for_epoch_sync: Duration::seconds(10),
        }
    }
}
...
pub fn default_epoch_sync() -> Option<LightEpochSyncConfig> {
    Some(LightEpochSyncConfig::default())
}
...
pub struct ClientConfig {
    ...
    pub epoch_sync: LightEpochSyncConfig,
...
impl ClientConfig {
    pub fn test(
        ...
        Self {
            ...
            epoch_sync: LightEpochSyncConfig::default(),
