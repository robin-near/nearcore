...
use near_epoch_manager::types::{EpochManagerStore, EpochManagerStoreUpdate};
...
impl EpochManagerAdapter for KeyValueRuntime {
    ...
    fn is_next_block_epoch_start(&self, parent_hash: &CryptoHash) -> Result<bool, EpochError> {
        ...
        let prev_block_header = self
            ...
            .ok_or_else(|| EpochError::MissingBlock(parent_hash.clone()))?;
        let prev_prev_hash = *prev_block_header.prev_hash();
    ...
    fn get_prev_epoch_id_from_prev_block(
        ...
        loop {
            let header = self
                ...
                .ok_or_else(|| EpochError::IOErr(candidate_hash.to_string()))?;
...
impl RuntimeAdapter for KeyValueRuntime {
    ...
    fn add_validator_proposals(
        ...
        Ok(EpochManagerStore::from(self.store.clone()).store_update())
    }
