...
pub trait PeerManagerAdapter: Sender<PeerManagerMessageRequest> + Sender<SetChainInfo> {}
impl<A: Sender<PeerManagerMessageRequest> + Sender<SetChainInfo>> PeerManagerAdapter for A {}
